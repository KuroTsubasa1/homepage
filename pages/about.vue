  ...
  <section class="py-16 bg-dark-100 relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 text-center relative z-10">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        ...
        <NuxtLink to="/cv" class="btn-neon inline-flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
          {{ t('about.cta.viewCv') }}
        </NuxtLink>
        <a href="/cv.pdf" target="_blank" rel="noopener" class="btn-neon-outline inline-flex items-center gap-2">
