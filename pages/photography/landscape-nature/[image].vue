<template>
  ...
  <header class="sticky top-0 bg-white shadow-md z-10">
    <div class="container mx-auto flex justify-between items-center px-4 py-3">
      <h1 class="text-2xl font-bold text-primary">{{ imageData.alt || 'Landscape & Nature Photography' }}</h1>
      <button
  ...
  <section class="related-images-section py-16 bg-gray-50">
    <div class="container mx-auto px-4">
      <h2 class="text-3xl font-bold text-primary mb-8 text-center">More Landscape & Nature Photography</h2>
