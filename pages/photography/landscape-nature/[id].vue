<template>
  ...
  <div class="container mx-auto py-16">
    <div class="text-center mb-8">
      <h1 class="text-4xl font-bold text-primary mb-4">{{ imageData.alt || 'Landscape & Nature Photography' }}</h1>
      <NuxtLink to="/photography/landscape-nature" class="btn btn-primary">
    ...
    <div class="max-w-4xl mx-auto px-4">
      ...
      <div class="bg-gray-50 p-6 rounded-lg shadow-md mb-8">
        ...
        <div class="space-y-3">
          ...
          <p><strong>Category:</strong> Landscape & Nature</p>
        </div>
      </div>
      ...
      <div class="flex justify-between">
        <a 
          v-if="prevImage" 
          :href="`/photography/landscape-nature/${prevImage.id}`" 
        ...
        <a 
          v-if="nextImage" 
          :href="`/photography/landscape-nature/${nextImage.id}`" 
          class="btn btn-outline btn-primary"
        >
          Next Image →
        </a>
...
onMounted(async () => {
  console.log('Landscape detail page mounted, All route params:', route.params);
  const id = route.params.id || '';
  console.log('Landscape detail - Using ID:', id);
