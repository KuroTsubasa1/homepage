<template>
  ...
  <header class="sticky top-0 bg-dark/80 backdrop-blur-xl border-b border-white/10 shadow-lg shadow-neon-cyan/5 z-10">
    <div class="container mx-auto flex justify-between items-center px-4 py-3">
      <h1 class="text-2xl font-bold text-white">{{ imageData.alt || 'Wildlife Photography' }}</h1>
      <button
  ...
  <section class="related-images-section py-16 bg-dark-100">
    <div class="container mx-auto px-4">
      <h2 class="text-3xl font-bold text-white mb-8 text-center">More Wildlife Photography</h2>
