<template>
  ...
  <div class="container mx-auto py-16">
    <div class="text-center mb-8">
      <h1 class="text-4xl font-bold text-primary mb-4">{{ imageData.alt || 'Wildlife Photography' }}</h1>
      <NuxtLink to="/photography/wildlife" class="btn btn-primary">
    ...
    <div class="max-w-4xl mx-auto px-4">
      ...
      <div class="flex justify-between">
        <a 
          v-if="prevImage" 
          :href="`/photography/wildlife/${prevImage.id}`" 
        ...
        <a 
          v-if="nextImage" 
          :href="`/photography/wildlife/${nextImage.id}`" 
          class="btn btn-outline btn-primary"
        >
          Next Image →
        </a>
...
onMounted(async () => {
  // Log all route params to diagnose the issue
  console.log('Wildlife detail page mounted, All route params:', route.params);
  const id = route.params.id || '';
  console.log('Wildlife detail - Using ID:', id);
