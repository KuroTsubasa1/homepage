<template>
  ...
  <div class="container mx-auto py-16">
    <div class="text-center mb-8">
      <h1 class="text-4xl font-bold text-primary mb-4">{{ imageData.alt || 'Abstract & Art Photography' }}</h1>
      <NuxtLink to="/photography/abstract-art" class="btn btn-primary">
    ...
    <div class="max-w-4xl mx-auto px-4">
      ...
      <div class="flex justify-between">
        <a 
          v-if="prevImage" 
          :href="`/photography/abstract-art/${prevImage.id}`" 
        ...
        <a 
          v-if="nextImage" 
          :href="`/photography/abstract-art/${nextImage.id}`" 
          class="btn btn-outline btn-primary"
        >
          Next Image →
        </a>
...
onMounted(async () => {
  console.log('Abstract detail page mounted, All route params:', route.params);
  const id = route.params.id || '';
  console.log('Abstract detail - Using ID:', id);
